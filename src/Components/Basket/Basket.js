...
export default function Basket() {
    ...
    let emptyBasket =
        <div className='basket-control'>
            ...
            <img className='blackBasket-control' src='/img/blackBasket.png' />
        </div>
    ...
    return (
        <div>
            {!state.flagDeliveryMethod && state.valueBascket || state.flagDeliveryMethod && state.valueBascketForDelivery  ?
                ...
                >
                    <span className='total-price'> {!state.flagDeliveryMethod?state.valueBascket:state.valueBascketForDelivery}</span><img className='white-basket' src='/img/Basket.png' />
                </button> : emptyBasket}
